#!/usr/bin/env python3
"""
Camera Controller Slave for Multiprocessing Integration with TaxiDriver
        ...
        while shutdown_flag.value == 0:
            ...
            with shared_detection_count.get_lock():
                ...
                for i in range(shared_detection_count.value):
                    ...
                    color_id = {'green': 1, 'red': 2, 'pink': 3}.get(detection['color'], 0)
...
def decode_detection_data(shared_detections, detection_count):
    ...
    detections = []
    color_map = {1: 'green', 2: 'red', 3: 'pink'}
